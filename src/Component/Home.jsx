...
const Home = ({ children }) => {
    ...
    return (<>
        ...
        >
            <SwiperSlide><img className="h-[14.5rem]" src="/img/swiper3.webp" /></SwiperSlide>
            <SwiperSlide><img className="h-[14.5rem]" src="/img/swiper5.webp" /></SwiperSlide>
            <SwiperSlide><img className="h-[14.5rem]" src="/img/swiper1.webp" /></SwiperSlide>
            <SwiperSlide><img className="h-[14.5rem]" src="/img/swiper2.webp" /></SwiperSlide>
        ...
        <div className="p-10">
            ...
            <div className="w-10/12 mx-auto   text-center grid grid-cols-5 gap-3 ">
