...
import LayoutAll from "./LayoutAll"; // ✅ Kept LayoutAll version
import Swal from "sweetalert2";
import uploadFile from "../util/firebase-config"; // ✅ Make sure uploadFile is actually exported from firebase-config
    ...
    <LayoutAll>
      ...
      <div className="mx-auto md:my-16 shadow-lg rounded-md p-8 md:w-7/12 border">
        ...
        {orders.map((item, index) => (
          <div className="flex gap-3 mb-8" key={index}>
            <img src={item.image} className="w-[100px]" alt={item.title} />
            <div>
      ...
      <div className="mx-auto md:my-16 shadow-lg rounded-md p-8 md:w-7/12 border">
        ...
        <div className="w-24 h-24 mx-auto relative mb-6">
          {uploading ? (
            <img src="/images/loader.gif" alt="Uploading..." />
          ) : (
            <img
